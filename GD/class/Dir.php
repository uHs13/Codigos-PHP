...
class Dir{
	...
	public function removeDir($path){//public static function -> funções estáticas, podemos chamar sem instanciar um objeto;

		//remove somente pastas com arquivos dentro. Se houver uma subpasta dá erro
		if($this->removeFiles($path)){
	...
	public static function removeFiles($path){
		...
		if(is_dir($path)){
			...
			throw new Exception("Error opening folder");
			return false;
