<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <?php require $this->checkTemplate("categoriesMenu");?>
                        </ul>                        
                    </div>
                </div>
    ...
    <!-- jQuery sticky menu -->
    <script src="http://localhost/PHP/ecommerce/res/site/js/owl.carousel.min.js"></script>
    <script src="http://localhost/PHP/ecommerce/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="http://localhost/PHP/ecommerce/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="http://localhost/PHP/ecommerce/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="http://localhost/PHP/ecommerce/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="http://localhost/PHP/ecommerce/res/site/js/script.slider.js"></script>
  </body>
</html>