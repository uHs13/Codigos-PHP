...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/PHP/ecommerce/admin/orders">Pedidos</a></li>
        <li class="active"><a href="/PHP/ecommerce/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/PHP/ecommerce/res/site/img/logo.png" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            <br>
            <b>Emitido em:</b> <?php echo htmlspecialchars( $order["dtregister"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
           <br>
            </div>
            <!-- /.col -->
        </div>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '/PHP/ecommerce/admin/orders/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
                    <i class="fa fa-pencil"></i> Editar Status
                </button>
                <button type="button" onclick="window.open('/PHP/ecommerce/boleto/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
